...
//    NSLog(@"currentMonth month = %i day = %i, todaydate day = %i",[currentMonth month],[currentMonth day],[todayDate month]);
    ...
    for (NSInteger i=0; i<numBlocks; i++) {
        ...
        [date drawInRect:CGRectMake(targetX+2, targetY+10, kVRGCalendarViewDayWidth, kVRGCalendarViewDayHeight) withFont:[UIFont boldSystemFontOfSize:17] lineBreakMode:UILineBreakModeClip alignment:NSTextAlignmentCenter];
    }
...
-(id)init {
    ...
    if (self) {
        ...
        labelCurrentMonth.font = [UIFont boldSystemFontOfSize:17];
